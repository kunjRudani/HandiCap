...
import '../handicape/custombar.dart';


class WriterEducation extends StatefulWidget {
  ...
  WriterEducation({required this.gender, required this.name, required this.number, required this.andhar, required this.address, required this.city, required this.state, required this.pincode, required this.disability,required this.image});

  @override
  State<WriterEducation> createState() => _WriterEducationState();
}

class _WriterEducationState extends State<WriterEducation> {
  String imageUrl1="";
  String imageUrl2="";
  String imageUrl3="";
  String imageUrl4="";
  ...
  Future<void> addData() {
    CollectionReference users = FirebaseFirestore.instance.collection("user").doc(FirebaseAuth.instance.currentUser?.email).collection("DetailsOfWriter");
    return users.doc()
        .set({
      "name":widget.name,
      ...
      "imageofboardX11paper":imageUrl2,
      "imageofbachelorpaper":imageUrl3,
      "imageofMasterpaper":imageUrl4,
      "imageofSchoolpaper":imageUrl5,
  ...
  Future<void> addDatas() {
    CollectionReference users = FirebaseFirestore.instance.collection("DetailsOfWriter");
    return users.doc()
        .set({
      "name":widget.name,
      "number": widget.number,
              ...
              Container(
                ...
                child: Center(
                  child: Padding(
                    ...
                    child: InkWell(
                      onTap: (){
                        Navigator.push(context, MaterialPageRoute(builder: (context) => custombar1(),));
                        addData();
                        addDatas();
                        },
                                      ...
                                      Visibility(
                                        ...
                                        child:IconButton(
                                          ...
                                          onPressed: () async{
                                            ...
                                            try{
                                              await  referenceImageTouplode.putFile(File(file!.path));
                                              imageUrl2=await referenceImageTouplode.getDownloadURL();
                                      ...
                                      Visibility(
                                        ...
                                        child: IconButton(
                                          ...
                                          onPressed: () async{
                                            ...
                                            try{
                                              await  referenceImageTouplode.putFile(File(file!.path));
                                              imageUrl3=await referenceImageTouplode.getDownloadURL();
                                      ...
                                      Visibility(
                                        ...
                                        child: IconButton(
                                          ...
                                          onPressed: () async{
                                            ...
                                            try{
                                              await  referenceImageTouplode.putFile(File(file!.path));
                                              imageUrl4=await referenceImageTouplode.getDownloadURL();
                                      ...
                                      Visibility(
                                        ...
                                        child: IconButton(
                                          ...
                                          onPressed: () async{
                                            ...
                                            try{
                                              await  referenceImageTouplode.putFile(File(file!.path));
                                              imageUrl5=await referenceImageTouplode.getDownloadURL();
